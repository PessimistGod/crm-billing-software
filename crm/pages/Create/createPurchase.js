...
const createPurchase = () => {
    ...
    const handleChange = (e) => {
        if (e.target.name == 'purchaseOwner') {
            setPurchaseOwner(e.target.value)
        }
    ...
    return (
        <section>
            ...
            <div className='flex justify-end mr-5'>
                ...
                <button onClick={PurchaseCreate} className='px-5 py-2 mt-6 bg-blue-600 text-sm lg:text-base text-white rounded-[4px] shadow-md'>Create Purchase</button>
            </div>
            <h4 className='text-black font-extrabold text-xl text-center mt-4'>Create Purchase</h4>
                        ...
                        <form className="w-full max-w-lg mx-auto mt-8">
                            ...
                            <div className="flex flex-wrap -mx-3 mb-6">
                                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="purchaseOwner">
                                        Purchase Owner
                                    </label>
                                    <input onChange={handleChange} name='purchaseOwner' value={purchaseOwner} className="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 contacting-tight focus:outline-none focus:bg-white" id="purchaseOwner" type="text" placeholder="Purchase Owner" />
                                </div>
                                <div className="w-full md:w-1/2 px-3">
                                    <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="vendorName">
                                        Vendor Name
                                    </label>
                                    <input onChange={handleChange} name='vendorName' value={vendorName} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 contacting-tight focus:outline-none focus:bg-white focus:border-gray-500" id="vendorName" type="text" placeholder="Vendor Name" />
                                </div>
                            </div>
